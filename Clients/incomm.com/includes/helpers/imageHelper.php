...
class imageHelper {
	 ...
	 */
	static public function round_corners($image=null,$radius=20,$color='ffffff',$transparency='127') {
		$width = imagesx($image);
		...
		$full_color = imageHelper::allocate_color($image2, $color, $transparency);
				...
				for ($x=$start_x;$x<$end_x;$x++) {
					for ($y=$start_y;$y<$end_y;$y++) {
						...
						if ($dist>($radius+1)) {
							...
							if ($dist>$radius) {
								$pct = 1-($dist-$radius);
								$color2 = imageHelper::antialias_pixel($image2, $x, $y, $full_color, $pct);
	 ...
	 * @return mixed
	 */
	static public function allocate_color($image=null,$color='268597',$transparency='0') {
	 ...
	 * @return mixed
	 */
	public static function antialias_pixel($image=null,$x=0,$y=0,$color=0,$weight=0.5)
	{
