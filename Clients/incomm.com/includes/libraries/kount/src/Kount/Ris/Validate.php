 ...
 * @version 0.1 SVN: $Id: Validate.php 19398 2012-04-19 00:34:33Z bpd $
...
class Kount_Ris_Validate {
   ...
   */
  static private function validateField ($rule, $name, $data) {
    $errors = array();
   ...
   */
  static private function findCartKeys ($data) {
