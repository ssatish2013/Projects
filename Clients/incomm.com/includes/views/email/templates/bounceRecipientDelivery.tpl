...
{include file="lang:bounceRecipientDeliverySubject"}
{/capture}

{capture name=text}
{include file="lang:bounceRecipientDeliveryTextBody"}
{/capture}

{capture name=title}
{include file="lang:bounceTitle"}
{/capture}

{capture name=html}
<table style="width:660px;">
  <tr>
	    <td valign="top" style="width:65%"><p style="font-size:1.2em">{include file="lang:bounceRecipientDeliveryBody"}</p></td>
