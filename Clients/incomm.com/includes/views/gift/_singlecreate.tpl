<div class="hidden">
	<ul>
		<li>
			...
			<input type="text" name="giftTitle" value="{if isset($gift)}{$gift->title}{/if}" data-target="#cardTitle" data-validate-required="true" data-validate-required-message="{$lang->giftTitleRequired}" />
		</li>
		<li>
			<span class="required">*</span>
			<label>
			...
			<input type="text" name="messageFromName" value="{if isset($message)}{$message->fromName}{/if}" data-target="#cardFrom" data-validate-required="true" data-validate-required-message="{$lang->fromRequired}" data-validate-minlength="{$settings->singleCreate->fromMin}" data-validate-minlength-message="{$lang->fromMinMsg}"  />
		</li>
		<li>
			<span class="required">*</span>
			<label>
			...
			<input type="text" name="giftRecipientName" value="{if isset($gift)}{$gift->recipientName}{/if}" data-validate-required="true" data-validate-required-message="{$lang->recipientNameRequired}" data-validate-minlength="{$settings->singleCreate->toMin}" data-validate-minlength-message="{$lang->toMinMsg}" />
		</li>
		<li>
			<span class="required">*</span>
			<label>
		...
		{if $settings->ui->deliveryTimeStatus == 1}{include file="gift/_deliverytime.tpl"}{/if}
	</ul>
	<ul>
		...
		<li>
			...
			<textarea name="messageMessage" data-validate-required="true" data-validate-required-message="{$lang->recipientMsgRequired}">{if isset($message)}{$message->message}{/if}</textarea>
		</li>
		...
		{if $settings->ui->hasCustomVideoOption}
			<li class="createMultimedia">
				<a href="#" class="button" id="videoUpload"><span>{$lang->uploadVideoMsg}</span></a><a class="help" title="{$lang->videoHelpTitle}"><img src="//gca-common.s3.amazonaws.com/assets/blank.png" /></a>
