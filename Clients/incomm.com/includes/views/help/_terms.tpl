...
{/literal}
{/capture}
{capture assign='dialogtitle'}{include file='lang:emailFooterTermsAndConditions'}{/capture}
{include file='help/bgheader.tpl'}
<div class="faq">
	<div class="ui-accordion ui-widget ui-widget-content">
	{include file='lang:terms'}
	</div>
