var jstz=function() { 
	var b = function(a){ 
		...
		return { 
			determine_timezone:function() { 
				...
				return e()
			}, determine:e,date_is_dst:function(a) { 
				var d=5<a.getMonth()?f():c(),a=b(a);
				return 0!==d-a
			}
		}
	}();
	...
	jstz.TimeZone=function(b) { 
		var c=null,c=b;"undefined"!==typeof jstz.olson.ambiguity_list[c]&&function() { 
