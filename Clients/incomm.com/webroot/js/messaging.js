...
// Library for cross-origin communication (a.k.a XDM)
var Messaging = function() {
	...
	var _isValidOrigin = function(origin, validHost) {
		return typeof validHost == 'undefined' || (_extractHttpHost(origin) == validHost);
	};
	...
	return {
		...
		, reply: function(message, originalEvent) {
			// Good browsers \o/
			if (!! window.postMessage) {
				originalEvent.source.postMessage(message, "*");
			}
			// Bad browsers /o\
			else {
